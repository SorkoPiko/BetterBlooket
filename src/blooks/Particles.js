...
function particleType(e) {
    switch (e) {
        ...
        case "right-diamond": {
            var a = random(0, data.scene.cameras.main.worldView.height);
            return {
                x: data.scene.cameras.main.worldView.width,
                y: a,
                scale: random(.7, 1),
        ...
        case "left-diamond": {
            var n = random(0, data.scene.cameras.main.worldView.height);
            return {
                x: 0,
                y: n,
                scale: random(.7, 1),
